...
#if((COMM_FULLCOMREQ_NOTIF != STD_OFF)&&(COMM_RTE_SUPPORT != STD_OFF))
extern VAR(ComM_UserHandleArrayType,COMM_VAR)  ComM_FullComRequestors[COMM_NO_OF_CHANNELS];
#endif
...
#if((COMM_FULLCOMREQ_NOTIF != STD_OFF)&&(COMM_RTE_SUPPORT != STD_OFF))
extern FUNC(void,COMM_CODE) ComM_LUpdateFullComRequestors(VAR(ComM_UserHandleType, COMM_VAR) User,VAR(ComM_ModeType, COMM_VAR) ComMode);
#endif
